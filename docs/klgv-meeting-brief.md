...
**Documento de trabajo para preparar y dar seguimiento a la reunión KLGV × Curia.**
KLGV debe describirse únicamente como **socio de diseño y primer cliente, en uso piloto**; nunca como despliegue completo en producción. [D §KLGV meeting context; G-KLGV; W-REL]
...
**Formato de 30 minutos, alineado con la revisión trimestral de KLGV:** Koki conduce el estado de la compañía y los hitos; Lic. García es dueño de las preguntas abiertas y decisiones. [G-QR; D §KLGV meeting context]

| Minutos | Bloque | Responsable | Resultado buscado |
|---|---|---|---|
| 0:00–0:02 | Apertura y marco | Koki | Confirmar que se revisará un piloto, no un despliegue completo; nombrar las dos decisiones esperadas. [W-REL] |
| 0:02–0:06 | Estado de Curia y del piloto | Koki | Resumir estado sin métricas no verificadas: KLGV es socio de diseño y primer cliente; Jalisco CJJ es la fuente operativa actual; otras jurisdicciones siguen en incorporación. [D §Product truth; W-REL] |
...
| 0:21–0:25 | Prioridad y límites | Lic. García decide; Koki facilita | Elegir uno de los flujos de mayor frecuencia para la siguiente ventana de evidencia y confirmar qué resultado cuenta como éxito. [W-REL; W-GTM] |
| 0:25–0:28 | Dos peticiones de esta reunión | Koki | Hacer solamente las dos marcadas **HACER AHORA** en “What to ask”; no añadir referencias, caso de estudio o intros salvo que Lic. García abra el tema. [G-5PATH] |
| 0:28–0:30 | Recap y cierre | Koki | Repetir decisiones, responsables, dependencias y fecha de comprobación; no improvisar compromisos de alcance o precio. [G-QR; W-REL] |
...
- No presentar Telegram, WhatsApp, OneDrive ni superficies de trabajo aún no liberadas como capacidades disponibles. [D §Product truth]
...
- [ ] **Superficies deshabilitadas:** confirmar que Telegram y las superficies de trabajo aún no liberadas siguen fuera de la demo; OneDrive no forma parte del flujo. [D §Product truth]
- [ ] **Microsoft 365:** verificar el estado del consentimiento de administrador en el tenant del piloto. Si está pendiente, demostrar el estado seguro de fallo y no forzar una escritura de calendario. El consentimiento correspondiente es requisito para la entrega en cola. [D §KLGV meeting context; G-MS365]
...
8. **CONDICIONAL — Autorización del caso de estudio:** “¿Está dispuesto a revisar una versión del caso de estudio y, sólo después de validar cada afirmación, otorgar autorización escrita para publicarlo? No se publicarán métricas ni cita testimonial sin su firma.” [G-CASE; W-GTM]
9. **CONDICIONAL — Ecosistema de inversión:** “¿Algún cliente o socio del despacho participa en una red de capital de riesgo mexicano y podría mediar una presentación con un fondo apropiado?” [G-5PATH]
10. **CONDICIONAL — Corresponsal CDMX:** “¿Sería útil explorar una presentación a través de un despacho corresponsal en CDMX hacia un fondo de capital de riesgo?” [G-5PATH]
11. **CONDICIONAL — Otras rutas del checklist:** “Si las rutas anteriores no encajan, ¿existe una asociación empresarial, universidad, aceleradora o red de fundadores pertinente para una presentación?” [G-5PATH]
...
**Respuesta acordada:** ver la respuesta y los límites en **Commercials → Términos actuales de KLGV**.

**Postura comercial futura:** el precio público de Curia sigue **TBD** hasta contar con evidencia de uso, disposición a pagar, carga de soporte, alcance y entidad contratante. No mezclar estos términos con precios históricos del PRD ni con ofertas de servicios de Agentic Engineering. [D §Product truth; W-PRICING]
...
### Términos actuales de KLGV

**Respuesta para KLGV:** “Cualquier término comercial se confirma contra el contrato vigente; este brief no constituye una lista pública de precios.” [D §KLGV meeting context; G-WHATSAPP]
- La relación se describe únicamente como **socio de diseño y primer cliente, en uso piloto**. No presentarla como despliegue completo en producción. [G-KLGV; W-REL]
- El piloto no demuestra por sí solo un precio de mercado ni un modelo repetible. [G-KLGV; W-REL]
- La política pública vigente para Curia es **pricing TBD** hasta validar uso, alcance, soporte y disposición a pagar. [D §Product truth; G-PRICING]
- No mezclar precios preliminares de los PRD, términos contractuales de KLGV o la escalera de ofertas de la agencia: son instrumentos distintos y los números históricos no están aprobados como precio público de Curia. [G-PRICING; W-PRICING]
...
- **Microsoft 365:** consentimiento de administrador del tenant del piloto concedido antes de tratar la entrega de calendario en cola como operativa. [G-MS365]
...
- **Claims y publicación:** permiso escrito, claims exactos, datos anonimizados/revisados y términos contractuales verificados antes de cualquier referencia o caso de estudio. [G-CASE; W-PRODGATE]

## Next steps

Las siguientes son acciones propuestas; Koki debe confirmarlas en voz alta al cierre y registrar cualquier cambio decidido por Lic. García.
...
| Antes de la reunión | **Koki** | Preparar apertura, estado y las dos preguntas **HACER AHORA**; mostrar únicamente claims y términos verificados y diferir las preguntas condicionales. | Agenda de 30 minutos y dos decisiones visibles. [G-QR; G-5PATH] |
| Durante la reunión | **Koki** | Facilitar tiempos, dar la palabra a Lic. García para decisiones y detener peticiones adicionales después de las dos principales. | Registro de decisión: flujo prioritario, evidencia aceptada, owner KLGV para MS365 y preguntas diferidas. [G-QR; G-5PATH] |
...
| Mismo día | **Koki** | Enviar recap de decisiones y dependencias; no incluir solicitudes condicionales que no se hicieron. | Recap aprobado por Lalo, con responsables y fechas. [G-5PATH] |
...
| Siguiente revisión | **Koki** | Revisar postura de renovación/expansión y decidir si una pregunta condicional reemplaza una de las dos peticiones de esa reunión. | Decisión registrada: renovar, mantener, ampliar o pausar, con gate y evidencia. [G-QR; W-REL] |
| Sólo después de estabilización | **Koki** | Si procede, pedir dos referencias de despachos **o** una ruta de intro, nunca todas juntas. | Permiso escrito, nombres exactos y autorización antes de contactar o mencionar a KLGV. [G-5PATH; G-SUCCESS] |
| Sólo con evidencia validada | **Koki**, revisión de **Lalo** y **Fernando** | Enviar el borrador de caso de estudio para autorización escrita; verificar cada claim y eliminar placeholders, datos personales no autorizados y afirmaciones sin evidencia. | Firma/autorización y versión final con claims comprobados; sin placeholders. [G-CASE; W-PRODGATE] |

**Cierre verbal recomendado:** “Confirmo dos acuerdos: priorizamos **[flujo]** y mediremos **[evidencia]**; para Microsoft 365, **[responsable]** coordina con Lalo antes de **[fecha]**. Todo lo demás queda pendiente; cualquier métrica, cita testimonial o nueva afirmación pública sobre KLGV requerirá autorización escrita.” [G-5PATH; G-CASE]

## Sources

Las etiquetas citan evidencia revisada por el equipo el 29/07/2026. Este brief conserva la categoría y el propósito de cada fuente sin depender de rutas de repositorio o sesiones de agentes.

- **[D]** Estado verificado del producto, reglas de marca y contexto de la reunión KLGV.
- **[G-KLGV]** Relación KLGV y posicionamiento aprobado del socio de diseño.
- **[G-SUCCESS]** Criterios de éxito del piloto y gates para referencias o caso de estudio.
- **[G-ONBOARD]** Onboarding KLGV, límites del producto y revisión humana.
- **[G-ALPHA]** Evidencia del alpha y estados de los flujos demostrables.
- **[G-MS365]** Consentimiento Microsoft 365, permisos y prueba de calendario.
- **[G-QA]** Matriz de smoke, ambientes y criterios de aprobación.
- **[G-5PATH]** Disciplina de relación y secuencia de solicitudes.
- **[G-QR]** Agenda de revisión trimestral y responsables.
- **[G-CASE]** Reglas de autorización y evidencia para el caso de estudio.
- **[G-WHATSAPP]** Guion de relación y términos vigentes sujetos al contrato.
- **[G-PRICING]** Política de pricing de Curia y separación de ofertas de la agencia.
- **[G-LAUNCH]** Estado de lanzamiento, dependencias y límites operativos.
- **[W-REL]** Historial y reglas de la relación KLGV.
- **[W-GTM]** Posicionamiento comercial y audiencias.
- **[W-PRICING]** Claims de pricing permitidos y no verificados.
- **[W-PRODGATE]** Gates de producción, publicación y aprobación.
- **[W-CLAIMS]** Registro de claims y política de honestidad de marketing.
- **[W-TEAM]** Roles y responsabilidades del equipo.
