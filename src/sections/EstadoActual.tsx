...
const statuses = [
  {
    ...
    title: "En piloto con un despacho socio de diseño",
    body: "Un despacho socio de diseño participa como primer cliente. Su uso en piloto guía la validación del flujo diario del despacho.",
    complete: false,
  },
  {
    icon: Landmark,
    ...
    title: "Jalisco CJJ registrado como fuente activa",
...
export default function EstadoActual() {
  return (
    <section
      id="estado-actual"
      className="border-y border-[var(--curia-border)] bg-[var(--curia-bg-subtle)] py-12 md:py-16"
    >
      <div className="curia-shell">
        <div className="grid gap-6 lg:grid-cols-[minmax(0,0.86fr)_minmax(0,1.14fr)] lg:items-end lg:gap-16">
          ...
          <p className="max-w-2xl text-base leading-7 text-[var(--curia-text-secondary)] md:text-lg md:leading-8 lg:pb-1">
            Curia está en piloto con un despacho socio de diseño desde julio de 2026. Jalisco CJJ está registrado como fuente activa; los demás estados están en incorporación. El alcance se comunica tal como existe hoy.
          </p>
        </div>
